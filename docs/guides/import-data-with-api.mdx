...
See our [supported file formats](./supported-file-formats.mdx). If you do not have 3D data handy, download one from our [3D model database](./model-database.mdx) to follow along. To create files in one of these formats, `POST` to the [createFile](https://docs.vertexvis.com/#a8f05429-036c-45b8-89ef-6bd3aa14a7fe) API.
