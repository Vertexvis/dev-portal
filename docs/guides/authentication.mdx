...
`OIDC_USERINFO_ENDPOINT` environment variable pointing to your [IdP’s
...
| Token Type         | Token Type Identifier                            | Supported |
| ------------------ | ------------------------------------------------ | --------- |
| JWT                | `urn:ietf:params:oauth:token-type:jwt`           | No        |
| Access Token       | `urn:ietf:params:oauth:token-type:access_token`  | Yes       |
| Refresh Token      | `urn:ietf:params:oauth:token-type:refresh_token` | No        |
| ID Token           | `urn:ietf:params:oauth:token-type:id_token`      | No        |
| SAML 1.1 Assertion | `urn:ietf:params:oauth:token-type:saml1`         | No        |
| SAML 2.0 Assertion | `urn:ietf:params:oauth:token-type:saml2`         | No        |
