...
## Get a Vertex Account and Application Credentials
If you already have a user account and a Client ID & Secret, you can skip these steps.
1. [Sign Up for a free Vertex Developer Account](https://account.vertexvis.com/signup)

  Once you signup, our team will create an account for you and send you an email.
2. [Generate Application Credentials](https://console.vertexvis.com/getting-started)

  You'll use the Application Credentials (Client ID, Secret) with calls to Vertex APIs to authenticate your requests.
