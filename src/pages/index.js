    ...
    logos: [
      {
        source: (
          <>
            <svg
              enable-background="new 0 0 71 95"
              viewBox="0 0 71 95"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="m20.3 72.3s-3.6 2.1 2.6 2.8c7.5.9 11.4.7 19.7-.8 0 0 2.2 1.4 5.2 2.6-18.6 7.9-42.1-.5-27.5-4.6m-2.3-10.4s-4.1 3 2.1 3.7c8 .8 14.4.9 25.4-1.2 0 0 1.5 1.5 3.9 2.4-22.4 6.5-47.5.4-31.4-4.9"
                fill="#5382a1"
              />
              <path
                d="m37.2 44.3c4.6 5.3-1.2 10-1.2 10s11.6-6 6.3-13.5c-5-7-8.8-10.5 11.9-22.5 0-.1-32.6 8.1-17 26"
                fill="#e76f00"
              />
              <path
                d="m61.8 80s2.7 2.2-3 3.9c-10.7 3.3-44.7 4.2-54.1.1-3.4-1.5 3-3.5 5-4 2.1-.5 3.3-.4 3.3-.4-3.8-2.5-24.4 5.4-10.5 7.6 37.9 6.2 69.1-2.8 59.3-7.2m-39.8-28.9s-17.3 4.1-6.1 5.6c4.7.6 14.1.5 22.8-.2 7.1-.6 14.3-1.9 14.3-1.9s-2.5 1.1-4.3 2.3c-17.5 4.6-51.4 2.5-41.7-2.3 8.3-3.9 15-3.5 15-3.5m31 17.3c17.8-9.3 9.6-18.2 3.8-17-1.4.3-2 .5-2 .5s.5-.8 1.5-1.2c11.4-4 20.1 11.8-3.7 18.1 0 .1.3-.1.4-.4"
                fill="#5382a1"
              />
              <path
                d="m42.3-1.2s9.9 9.9-9.4 25.1c-15.4 12.2-3.5 19.1 0 27.1-9-8.1-15.6-15.3-11.2-21.9 6.5-9.8 24.5-14.6 20.6-30.3"
                fill="#e76f00"
              />
              <path
                d="m23.8 93.5c17.1 1.1 43.4-.6 44-8.7 0 0-1.2 3.1-14.1 5.5-14.7 2.8-32.7 2.5-43.4.7 0 0 2.2 1.8 13.5 2.5"
                fill="#5382a1"
              />
            </svg>
          </>
