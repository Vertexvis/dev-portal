...
function SupportCard({ title, description, icon, callout, cta_links, classes }) {
  return (
    <div className={classnames('gs-guide', classes, styles.gsGuide, styles.textLeft)}>
      <div
          ...
          {cta_links.length &&
            cta_links.map((link, index) => (
              <p key={index}>
				  ...
				  : <Link className={classnames('sdk-link non-button-link')} to={link.url}>{link.text}</Link>
				}
              </p>
            ))}
        </div>
      ...
      <header className={classnames(styles.LPhero)}>
        <div className={classnames('container')}>
          <div className={classnames('row')}>
            <div className={classnames('col', 'col--12', styles.supportCardsIntro)}>
          ...
          <div className={classnames('row')}>
            <div className={classnames('col col--9')}>
              <h2 className={classnames(styles.logoMark, styles.githubMark)}>
                Be sure to check out our <Link to={'#'}>Vertex Community Discussions</Link>{' '}
                for more questions and answers from Vertex engineers and other 
                developers.
              </h2>
            </div>
