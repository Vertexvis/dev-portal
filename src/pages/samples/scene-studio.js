...
const SSFeatures = [
  {
	icon: (
      <>
        <svg height="28" viewBox="0 0 26 28" width="26" xmlns="http://www.w3.org/2000/svg"><path d="m28.44 8.1-12-6c-.2768417-.13910511-.6031583-.13910511-.88 0l-12 6c-.34013205.17183734-.55611028.51894521-.56.9v14c.00388972.3810548.21986795.7281627.56.9l12 6c.2768417.1391051.6031583.1391051.88 0l12-6c.340132-.1718373.5561103-.5189452.56-.9v-14c-.0038897-.38105479-.219868-.72816266-.56-.9zm-13.44 19.28-10-5v-11.76l10 5zm1-13.5-9.76-4.88 9.76-4.88 9.76 4.88zm11 8.5-10 5v-11.76l10-5z" fill="#616161" fill-rule="evenodd" transform="translate(-3 -2)"/></svg>
      </>
    ),
...
function SSFeature({ icon, title, description, width }) {
  return (
    <div className={classnames('col', width, styles.sceneStudioFeature)}>
      <div className={classnames(styles.gsGuideContent, styles.cardContent, styles.sceneStudioFeatureContent)}>
         <div className={classnames('content')}>
           {icon}
           <h2>{title}</h2>
           <div className={classnames('intro')}>
             <div className={classnames(styles.sceneStudioFeatureDescription)}>{description}</div>
           </div>
        </div>
      </div>
    </div>
        ...
        <div className={classnames('container')}>
          <div className={classnames('row')}>
            <div className={classnames('col')}>
              <h1>Scene Studio <span className={classnames('tag-pill')}>Beta</span></h1>
              <p>
